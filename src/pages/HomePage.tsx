        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          {upcomingEvents.length > 0 && (
            ...
            >
              <Link to="/events">
                <motion.span
                  className="inline-flex items-center px-8 py-3 radius font-display font-extrabold gap-2 border-2 border-white text-white hover:bg-white hover:text-black cursor-pointer"
                  style={{
                    transition: `background-color ${duration.fast * 1000}ms cubic-bezier(0.165, 0.84, 0.44, 1), color ${duration.fast * 1000}ms cubic-bezier(0.165, 0.84, 0.44, 1)`
                  }}
