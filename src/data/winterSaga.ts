...
export const WINTER_SAGA_DATA: SagaEventConfig[] = [
        ...
        twinEventDates: [
            {
                date: '01.01',
                titleSuffix: 'Day 1',
                subtitle: 'УТРО НОВОГО ГОДА',
                description: 'Первое января. Все устали после главной ночи года. Приходи в пижаме, будем отсыпаться вместе.',
                hooks: {
                    main: 'первый день года. голова гудит, тело просит покоя. пижамы обязательны',
                    story: 'похмелье — тоже праздник. мягкий свет, тёплые пледы, кино на экранах',
                    alternate: 'проснулся первого января и не знаешь куда себя деть? мы знаем'
                }
            },
            {
                date: '02.01',
                titleSuffix: 'Day 2',
                subtitle: 'ПРОДОЛЖЕНИЕ УЮТА',
                description: 'Второй день пижамной вечеринки. Восстанавливаемся вместе, продлеваем атмосферу домашнего комфорта.',
                hooks: {
                    main: 'для тех, кто не готов возвращаться в реальность. ещё один день уюта',
                    story: 'когда один день пижамной вечеринки — это слишком мало',
                    alternate: 'продолжаем отдыхать. кофе, пледы и хорошая компания'
                }
            }
        ]
    },
    ...
    },
    {
        ...
        twinEventDates: [
            {
                date: '06.01',
                titleSuffix: 'Светлый День',
                subtitle: 'ДОБРАЯ МАГИЯ',
                description: 'Рождественская магия Хогвартса. Светлые заклинания, сливочное пиво, атмосфера праздника в волшебном замке.',
                hooks: {
                    main: 'светлая сторона магии. рождество в хогвартсе. гриффиндор и пуффендуй одобряют',
                    story: 'сливочное пиво на баре, патронусы в воздухе, эхо рождественского пира',
                    alternate: 'для тех, кто всегда верил в магию. дамблдор был бы рад'
                },
                vibeLabel: 'LIGHT MAGIC',
                dressCode: 'Мантии светлых факультетов, рождественские свитера'
            },
            {
                date: '07.01',
                titleSuffix: 'Тёмная Ночь',
                subtitle: 'ТЁМНЫЕ ИСКУССТВА',
                description: 'Слизерин берёт верх. Тёмная ночь магии — Азкабан отдыхает, а мы нет.',
                hooks: {
                    main: 'тёмная сторона магии. слизерин не спрашивает разрешения. добро пожаловать в запретную секцию',
                    story: 'когда приличные волшебники спят — начинается настоящее веселье',
                    alternate: 'для тех, кто знает: морсмордре — это не заклинание, а стиль жизни'
                },
                vibeLabel: 'DARK ARTS',
                dressCode: 'Тёмные мантии, маски пожирателей смерти, готика'
            }
        ]
    },
    {
        ...
        twinEventDates: [
            {
                date: '09.01',
                titleSuffix: 'Day 1',
                subtitle: 'САНТЫ УСТАЛИ',
                description: 'Первый день финала. Санты потрёпаны, праздники измотали, но сдаваться никто не собирается.',
                hooks: {
                    main: 'санты устали, но не сдаются. первый день большого финала',
                    story: 'когда подарки закончились, а веселье — нет. bad santa одобряет',
                    alternate: 'два дня, чтобы закрыть сагу. начинаем прощание с праздниками'
                }
            },
            {
                date: '10.01',
                titleSuffix: 'Day 2',
                subtitle: 'ПОСЛЕДНИЙ ТАНЕЦ',
                description: 'Финальная ночь саги. Всё, что было — останется воспоминанием. Закрываем сезон с размахом.',
                hooks: {
                    main: 'последняя ночь зимней саги. прощаемся с праздниками так же громко, как начинали',
                    story: 'финальная точка. завтра всё закончится, но сегодня мы ещё здесь',
                    alternate: 'конец истории. но какой конец! самый громкий финал сезона'
                }
            }
        ]
    }
